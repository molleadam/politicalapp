...
public class EasyTracker {
  ...
  public void trackActivityStart(final Activity activity) {
	  Log.e("Tracer","Activity Starterd");
    activitiesActive++;
      ...
      public void run() {
        if (startASession) {
          ...
          if (!autoActivityTracking) {
        	  Log.e("Tracer","Activity registered not auto trace:"+getActivityName(activity));
        ...
        if (autoActivityTracking) {
        	Log.e("Tracer","Activity registered auto trace:"+getActivityName(activity));
          getGoogleAnalyticsTracker().trackPageView(getActivityName(activity));
        }
      }  
    });
